<?php
    ...
    //var_dump($nombre);
    $sql_leer = "SELECT * FROM playlist WHERE id = '$id'";
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 order-lg-1 order-2 sidebar_col">
                                <div class="sidebar">
                                    ...
                                    <form method=POST action=editar_playlist.php>
                                        <div class="form-group">
                                            <label for="exampleSelect1">Selecciona una Playlist para editar</label>
                                            ...
                                            <button type="submit" name="editar_pl" class="btn btn-primary" style=margin-top:15px;background-color:#fd99a7;border-color:#fd99a7;border-radius:1.5rem;>Editar Playlist</button>
                                        </div>
                                    </form> -->
                                ...
                                <div class="blog_posts">
                                    ...
                                    <div
                                        ...
                                        <div class="blog_post_date">
                                            <a href="#">
                                                <?php echo $dato['followers'] ?>
                                                ❤</a>
                                        </div>
                                        <div class="blog_post_content">
                                            <div class="blog_post_title">
                                                <a href="#" disabled="disabled"><?php echo $dato['name_p'] ?></a>
                                                By
                                                <?php echo $nombre ?>

                                            </div>
                                            <div class="row">
                                                <form method="post" action="eliminar_playlist.php">
                                                    <input
                                                        name="eliminar_pl"
                                                        style="margin-top:5px;margin-right:10px; margin-left:14px"
                                                        type="submit"
                                                        value="Eliminar">
                                                    <input type="hidden" name="id_p" value=<?php echo $dato['id_p']?>>
                                                </form>
                                                <form method="post" action="editar_playlist.php">
                                                    
                                                    <input type="hidden" name="id_p" value="<?php echo $dato['id_p']?>">
                                                    <input type="hidden" name="name_p" value="<?php echo $dato['name_p']?>">
                                                    <input type="hidden" name="name_u" value="<?php echo $nombre?>">
                                                    <input
                                                        name="editar"

    ...
    <div class="page-wrapper bg-gra-01 p-t-180 p-b-100 font-poppins">
        <div class="wrapper wrapper--w780">
            <div class="card card-3">
                ...
                <div class="card-body">
                    <h2 class="title">Regístrate como Artista </h2>
                    ...
                    <form method="POST">
                        <div class="input-group">
                            ...
                            <div class="input-group">
                                <input class="input--style-3" type="text" placeholder="Nombre de Artista" name="artistname" required>
                            </div>
                            ...
                            <div class="input-group">
                                <input class="input--style-3" type="password" required pattern="[A-Za-z0-9]*" placeholder="Contraseña" name="pass" required>
                            </div>
                            <div class="p-t-10">
...
if ($_POST){
    ...
    if (count($resultado) >= 1){
        ...
        $sql_insert_user = "INSERT INTO artista (id,user_name1) VALUES ('$id','$username')";

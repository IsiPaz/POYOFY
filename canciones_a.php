<?php
    ...
    $sql_leer = "SELECT * FROM canciones WHERE id = '$id' ";
	...
	<div class="home">
		...
		<div class="home_container d-flex flex-column align-items-center justify-content-center">
			<div class="home_content">
				<div class="home_title"><h1>Canciones de <?php echo $nombre ?></h1></div>
			</div>
		</div>
	</div>
			...
			<div class="row episodes_row">
				...
				<div class="col-lg-3">
					<div class="sidebar">
						...
						<!-- <form method="POST" action="canciones_seguidas_a.php" id="comment_form" class="comment_form">							
							<input type="hidden"  name="id" value=<?php echo $id?>>
							<button type="submit" class="btn btn-secondary" name="crear" style=background-color:#fd99a7;border-color:#fd99a7;>Canciones Seguidas</button>
						</form> -->
				...
				<div class="col-lg-9 episodes_col">
					<div class="episodes_container">
						...
						<div class="episode d-flex flex-row align-items-start justify-content-start *">
							<div>
							...
							<div class="episode_content">
                                <?php 
                                    $id_a = $dato['id_a'];
                                    $sql_album = "SELECT name_a FROM albumes WHERE id_a = '$id_a'";
                                    $gsent = $pdo->prepare($sql_album);
                                    $gsent->execute();
                                    $album = $gsent->fetchAll();
                                    
                                    if (count($album)==0){
                                        $nombre_album = " ";
                                    }
                                    else{
                                        $nombre_album = $album[0]['name_a'];
                                    }

                                ?>
                                <div class="episode_name"><a href="episode.html"><?php echo $dato['name_c']?> - <?php echo $nombre_album ?></a></div>

								<div class="episode_date"><a href="#"><?php echo $dato['released'] ?> </a></div>
												...
												<div class="player_controls">
													<div class="jp-gui jp-interface d-flex flex-row align-items-center justify-content-start">
														...
														<div class="jp-volume-controls d-flex flex-row align-items-center justify-content-between ml-auto">
															...
															<form method="post" action="eliminar_cancion.php">
																<input name="eliminar" style="margin-right:10px" type="submit" value="Eliminar">
																<input type="hidden"  name="id_s" value=<?php echo $dato['id_s']?>>
															</form> 
															<form method="post" action="update_cancion.php">
																<input type="hidden"  name="id_s" value=<?php echo $dato['id_s']?>>
																<input type="hidden"  name="name_c" value=<?php echo $dato['name_c']?>>
																<input name="editar" style="margin-right:10px"  type="submit"  value="Editar" >

...
$seguidos_sql = "SELECT * FROM usuarios WHERE id IN (SELECT id FROM personas WHERE id IN (SELECT id_2 FROM personas_seguidas WHERE id_1 = '$id') AND NOT id ='$id')";
$p = $pdo->prepare($seguidos_sql);
$p->execute();
$seguidos = $p->fetchAll();

$no_seguidos_sql = "SELECT * FROM usuarios WHERE id IN (SELECT id FROM personas WHERE id NOT IN (SELECT id_2 FROM personas_seguidas WHERE id_1 = '$id' ) AND NOT id ='$id')";
    ...
    <div class="container text-center text-white">
        <div class="row pt-5">
            <div class="col-lg-8 mx-auto">
                <h2 style=color:#000;padding-top:3rem!important;>Usuarios que tú sigues</h2>
                <p class="lead mb-0">Aqui puedes ver todos los Usuarios que sigues</p>
                </div>
            </div>
        </div><!-- End -->
                            ...
                            <tbody>
                                <?php foreach($seguidos as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-4">
                                            <form method="post" action="unfollow_user1.php">
...
<div class="col-12">
    ...
    <div class="container text-center text-white">
        <div class="row pt-5">
            <div class="col-lg-8 mx-auto">
                <h2 style=color:#000;padding-top:3rem!important;>Explora Usuarios</h2>
                <p class="lead mb-0">Aqui puedes ver todos los Usuarios que aún no sigues</p>
                </div>
            </div>
        </div><!-- End -->
                            ...
                            <tbody>
                                <?php foreach($no_seguidos as $row1): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-4">
                                            <form method="post" action="follow_user1.php">
                                                <input type="hidden"  name="id" value=<?php echo $id ?>>
                                                <input type="hidden"  name="id_us" value=<?php echo $i1 ?>>

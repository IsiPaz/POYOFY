    ...
    <div class="container text-center text-white">
        <div class="row pt-5">
            <div class="col-lg-8 mx-auto">
                <h2 style=color:#000;padding-top:3rem!important;>Playlists que tú sigues</h2>
                <p class="lead mb-0">Aqui puedes ver todos los Playlists que sigues</p>
                </div>
            </div>
        </div><!-- End -->
                            ...
                            <tbody>
                                <?php foreach($seguidos as $row): ?>
                                    <?php 
                                        ...
                                        $id_p = $row['id_p'];
                                        $name_pla= $row['name_p'];
                                        $seguidores1 = $row['followers'];
                                        $follows1 = "SELECT user_name1 FROM usuarios WHERE id='$i'";
                                        $lol1 = $pdo->prepare($follows1);
                                        $lol1->execute();
                                        $res1 = $lol1->fetchAll();
                                    ...
                                    <tr>
                                        <th scope="row" class="col-3"><?php echo $name_pla ?></th>
                                        <td class="col-3"><?php echo $creador1 ?></td>
                                        <td class="col-3"><?php echo $seguidores1 ?></td>
                                        <td class="col-3">
                                            <form method="post" action="ver_pl.php">
                                                <input type="hidden"  name="play" value="<?php echo $name_pla ?>">
                                                <input type="hidden"  name="id_pl" value=<?php echo $id_p ?>>
                                                <input type="hidden"  name="seguidores" value=<?php echo $seguidores1 ?>>
                                                <input type="hidden"  name="creador" value=<?php echo $creador1 ?>>
                                                <input name="follow_pl" style="margin-right:10px;margin-left:15px" type="submit" value="Ver más">
                            ...
                            <tbody>
                                <?php foreach($no_seguidos as $row1): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td class="col-3">
                                            <form method="post" action="ver_pl_unf.php">

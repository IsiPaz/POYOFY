<?php
	...
	//var_dump($nombre);
	$sql_leer = "SELECT * FROM canciones";

    $gsent = $pdo->prepare($sql_leer);
    $gsent->execute();

	$result = $gsent->fetchAll(); //añadir
		...
		<div class="episode_image_container">
			<div class="container">
				<div class="row">
					<div class="col-lg-3">
						<!-- Episode Image -->
						<div class="episode_image"><img src="images/u_profile.png" alt=""></div>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-3 order-lg-1 order-2 sidebar_col">
					<div class="sidebar">
						...
						<button type="button" class="comment_button button_fill" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo" >Cambiar datos</button>
						</div>		

						<form method="post" action="">
							<input type="hidden" name="id" value=<?php echo $id ?>>
							<button class="comment_button button_fill" type="submit" name="eliminar_cuenta">Eliminar cuenta</button>
						</form>
							<ul>
				...
				<div class="col-lg-9 episode_col order-lg-2 order-1">
					...
					<div class="comment_form_container">
						<div class="section_title">Crea una Playlist</div>
						<form method="POST" id="comment_form" action="crear_playlist.php" class="comment_form">
							<div class="row">
								<div class="col-md-12">
									<input type="text" class="comment_input" name="nombre_pl" placeholder="Nombre de la Playlist" required="required">
								</div>
								<input type="hidden" name="id" value=<?php echo $id ?>>
							</div>
							<div>
								...
								<input type="hidden" name="nombre_album" value=<?php echo $nombre_album ?>>
								<input type="hidden" name="nombre_artista" value=<?php echo $nombre_artista ?>>
							</div>
							<button class="comment_button button_fill" name="crear_pl">Crear</button>
						</form>
					</div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method=POST action="update_cuenta_user.php">
          <div class="form-group">
            ...
            <select class="form-control" name="campo" required>
				...
				<option>Email</option>
				<option>Constraseña</option>
			</select>
          </div> 
		  <div class="form-group">
            <label for="recipient-name" class="col-form-label">Ingrese el nuevo valor</label>
            <input type="text" name="new" class="form-control" placeholder="" id="recipient-name" required>
          </div>
			<!-- 		  <div class="form-group">

<?php
    ...
    $sql_leer = "SELECT * FROM playlist WHERE id_p IN (SELECT id_p FROM personas_playlist WHERE id = '$id')";
                    ...
                    <div
                        ...
                        <div class="home_content">
                            <div class="home_title">
                                <h1>Playlists ❤ <?php echo $nombre ?></h1>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <?php foreach($result as $dato): ?>
                                        <div
                                            ...
                                            <div class="blog_post_date">
                                                <a href="#"><?php echo $dato['followers'] ?> ❤</a>
                                            </div>
                                            <div class="blog_post_content">
                                                <div class="blog_post_title">
                                                    <?php 
                                                        $idd = $dato['id'];
                                                        $user_creador = "SELECT user_name1 FROM usuarios WHERE id ='$idd'";
                                                        $a = $pdo->prepare($user_creador);
                                                        $a->execute();

                                                        $name_c = $a->fetchAll();
                                                    
                                                    ?>
                                                    <a href="#" disabled="disabled"><?php echo $dato['name_p'] ?></a> By <?php echo $name_c[0]['user_name1'] ?>
                                                ...
                                                <div class="row">
                                                    <form method="post" action="dislike_playlist.php">
                                                        ...
                                                        <input
                                                            name="dislike_pl" style="margin-top:5px;margin-right:10px; margin-left:14px"
                                                            type="submit"
                                                            value="Dislike">
